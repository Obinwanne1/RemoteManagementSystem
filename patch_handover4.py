...
# ── 1. Login MFA note ─────────────────────────────────────────────────────────
# Exact chars from chunk.txt -- curly quotes, em-dash
patch(
...
patch(
    ...
    "\n"
    "> **WARNING:** Keep the superadmin password in a secure password manager",
    "Then restart the Flask API. The account will be updated on next startup.\n"
    "\n"
...
# ── 3. Alerts CSV export ──────────────────────────────────────────────────────
# Check the exact text around "Acknowledging an Alert"
patch(
