#!/usr/bin/env python3
"""Patch HANDOVER_GUIDE.md with all new changes."""
import re
...
print("2. substitutions table updated")
...
print("5. superadmin credentials updated")
...
print("6. superadmin env note added")
...
print("7. devices CSV export added")

# ── 8. Add two-step delete confirmation note to Devices chapter ───────────────
OLD8 = (
...
assert OLD8 in content, "agentless NOTE not found"
content = content.replace(OLD8, NEW8, 1)
print("8. device delete confirmation added")
...
print("9. tickets CSV export added")
...
print("10. alerts CSV export added")
...
print("11. audit log CSV export added")

# ── 12. Insert new Chapter 9a (MFA) after Chapter 9 ─────────────────────────
...
print("12. Chapter 9a MFA inserted")

# ── 13. Insert new Chapter 9b (My Profile page) ──────────────────────────────
OLD13 = "## Chapter 10: Your Role and What You Can Access"
NEW13 = """\
...
## Chapter 10: Your Role and What You Can Access"""
assert OLD13 in content, "Chapter 10 heading (second) not found"
content = content.replace(OLD13, NEW13, 1)
print("13. Chapter 9b My Profile inserted")

# ── 14. Insert Docker deployment chapter after Chapter 7 ──────────────────────
OLD14 = "# PART II — GETTING STARTED"
NEW14 = """\
...
> **IMPORTANT:** `DATABASE_URL` uses `@db:5432` not `@localhost:5432`. Inside Docker's network, the database container is reachable at the name `db`.
...
assert OLD14 in content, "PART II heading not found"
content = content.replace(OLD14, NEW14, 1)
print("14. Docker chapter inserted")
...
assert OLD15 in content, "TOC Part I/II not found"
content = content.replace(OLD15, NEW15, 1)
print("15. TOC updated")

# ── 16. Update Quick Reference Card — Administrators ─────────────────────────
OLD16 = (
...
assert OLD16 in content, "monthly security checklist not found"
content = content.replace(OLD16, NEW16, 1)
print("16. admin checklist updated")

# ── 17. Add MFA to glossary ───────────────────────────────────────────────────
OLD17 = "| Memurai | Windows-native Redis-compatible server."
NEW17 = (
...
assert OLD17 in content, "Memurai glossary entry not found"
content = content.replace(OLD17, NEW17, 1)
print("17. MFA glossary entry added")

# ── 18. Add Docker to glossary ────────────────────────────────────────────────
OLD18 = "| Defragmentation | Disk maintenance for HDDs"
NEW18 = (
...
assert OLD18 in content, "Defragmentation glossary entry not found"
content = content.replace(OLD18, NEW18, 1)
print("18. Docker glossary entry added")

# ── 19. Add MFA troubleshooting entry ────────────────────────────────────────
OLD19 = "### Problem: Cannot access Admin page — \"Admin access required\""
NEW19 = (
    ...
    "or is less than 10 characters. This is now a hard requirement — the API will not start without it.\n"
    "\n"
    "**Steps:**\n"
...
assert OLD19 in content, "Admin access required troubleshoot not found"
content = content.replace(OLD19, NEW19, 1)
print("19. MFA + SUPERADMIN_PASSWORD troubleshooting added")

# ── 20. Add Docker troubleshooting entry ─────────────────────────────────────
OLD20 = "### Starting All Services — Quick Reference"
NEW20 = (
...
assert OLD20 in content, "Starting All Services section not found"
content = content.replace(OLD20, NEW20, 1)
print("20. Docker troubleshooting added")

assert len(content) > original_len, "content did not grow"
print(f"\nOriginal: {original_len} chars → Updated: {len(content)} chars (+{len(content)-original_len})")
